...
// packages/router-devtools-core/dist/esm/tokens.js
var tokens = {
  colors: {
    inherit: "inherit",
...
// packages/router-devtools-core/dist/esm/useStyles.js
...
// packages/router-devtools-core/dist/esm/useLocalStorage.js
var getItem = (key) => {
  try {
...
// packages/router-devtools-core/dist/esm/utils.js
...
// packages/router-devtools-core/dist/esm/Explorer.js
...
// packages/router-devtools-core/dist/esm/AgeTicker.js
...
// packages/router-devtools-core/dist/esm/BaseTanStackRouterDevtoolsPanel.js
...
var BaseTanStackRouterDevtoolsPanel = function BaseTanStackRouterDevtoolsPanel2(_a) {
  ...
  const _b = panelProps, {
    className: className$1,
    style
  } = _b, otherPanelProps = __objRest(_b, [
    "className",
    "style"
  ]);
  ...
  const activeMatchLoaderData = createMemo(() => {
    var _a3;
    return (_a3 = activeMatch()) == null ? void 0 : _a3.loaderData;
  });
  ...
  return (() => {
    ...
    insert(_el$24, (() => {
      ...
      return () => _c$3() ? (() => {
        ...
        insert(_el$35, () => {
          var _a3;
          return (_a3 = routerState().location.maskedLocation) == null ? void 0 : _a3.pathname;
        });
    ...
    insert(_el$31, (() => {
      ...
      return () => _c$4() ? createComponent(RouteComp, {
        ...
        insert(_el$36, () => {
          var _a3, _b2;
          return (_b2 = ((_a3 = routerState().pendingMatches) == null ? void 0 : _a3.length) ? routerState().pendingMatches : routerState().matches) == null ? void 0 : _b2.map((match, i2) => {
            return (() => {
    ...
    insert(_el$13, (() => {
      var _c$6 = createMemo(() => {
        var _a3;
        return !!(activeMatch() && ((_a3 = activeMatch()) == null ? void 0 : _a3.status));
      });
      return () => _c$6() ? (() => {
        ...
        insert(_el$53, (() => {
          var _c$8 = createMemo(() => {
            var _a3, _b2;
            return !!(((_a3 = activeMatch()) == null ? void 0 : _a3.status) === "success" && ((_b2 = activeMatch()) == null ? void 0 : _b2.isFetching));
          });
          return () => {
            var _a3;
            return _c$8() ? "fetching" : (_a3 = activeMatch()) == null ? void 0 : _a3.status;
          };
        })());
        insert(_el$57, () => {
          var _a3;
          return (_a3 = activeMatch()) == null ? void 0 : _a3.id;
        });
        insert(_el$60, (() => {
          var _c$9 = createMemo(() => {
            var _a3;
            return !!((_a3 = routerState().pendingMatches) == null ? void 0 : _a3.find((d) => {
              var _a22;
              return d.id === ((_a22 = activeMatch()) == null ? void 0 : _a22.id);
            }));
          });
          return () => _c$9() ? "Pending" : routerState().matches.find((d) => {
            var _a3;
            return d.id === ((_a3 = activeMatch()) == null ? void 0 : _a3.id);
          }) ? "Active" : "Cached";
        })());
        insert(_el$63, (() => {
          var _c$10 = createMemo(() => {
            var _a3;
            return !!((_a3 = activeMatch()) == null ? void 0 : _a3.updatedAt);
          });
          return () => {
            var _a3;
            return _c$10() ? new Date((_a3 = activeMatch()) == null ? void 0 : _a3.updatedAt).toLocaleTimeString() : "N/A";
          };
        })());
        insert(_el$48, (() => {
        ...
        createRenderEffect((_p$) => {
          var _a3, _b2;
          var _v$40 = styles().thirdContainer, _v$41 = styles().detailsHeader, _v$42 = styles().matchDetails, _v$43 = styles().matchStatus((_a3 = activeMatch()) == null ? void 0 : _a3.status, (_b2 = activeMatch()) == null ? void 0 : _b2.isFetching), _v$44 = styles().matchDetailsInfoLabel, _v$45 = styles().matchDetailsInfo, _v$46 = styles().matchDetailsInfoLabel, _v$47 = styles().matchDetailsInfo, _v$48 = styles().matchDetailsInfoLabel, _v$49 = styles().matchDetailsInfo, _v$50 = styles().detailsHeader, _v$51 = styles().detailsContent;
...
//# sourceMappingURL=chunk-BCQDO4RV.js.map
